...
# Function
# In: nothing
# Method: selects a random number from 1 to 6 
# Variables
#   dice_number: integer from 1 to 6
# Out: random integer from 1 to 6
def roll_result():
    dice_number = r.randint(1, 6)
    return dice_number

# Function
# In: array: current players, object: the current player
# Method: checks index of current player in players array
# Variables
#   players: Array of players
#   current: current player object
# Out: index of current player
...
# Function
# In: array: object: the current player
# Method: sets players points in round to 0
# Variables
